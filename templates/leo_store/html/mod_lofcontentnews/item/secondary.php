...
$item = modLofContentNews::onBeforeRender( $item, $sDescriptionMaxChars, $limitDescriptionBy, $params->get('itemAuthor',1) ); ?>
<li class="lof-item">
    
    <?php if( $sShowImage ) : ?>
      <?php  echo  modLofContentNews::getImage( $item, $sImageWidth, $sImageHeight, $isThumb ); ?>
    <?php endif; ?>
    ...
    <div class="lof-description">
    	...
    	<div class="lof-counter">
    		<?php if( $params->get('itemHits',1) ): ?>
            	<div class="lof-item-hits"><b><?php echo (int)$item->hits; ?></b></div>       
        	<?php endif; ?>
    	</div>		        
    <?php endif; ?>
</li>