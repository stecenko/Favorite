...
// 		vmdebug('$this->cart->products',$this->cart->products);
		foreach( $this->cart->products as $pkey =>$prow ) { ?>
			<tr valign="top" class=" info sectiontableentry<?php echo $i ?>">
				<td align="left" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_NAME') ?>" >
				...
				<td align="left" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_SKU') ?>" ><?php  echo $prow->product_sku ?></td>
				<td align="center" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_PRICE') ?>" >
				<?php
...
// 					echo $prow->salesPrice ;
				...
				<td align="right" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_QUANTITY') ?>" ><form action="<?php echo JRoute::_('index.php'); ?>" method="post" class="inline">
				...
				<?php if ( VmConfig::get('show_tax')) { ?>
				<td align="right"  data-label="<?php echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php echo "<span class='priceColor2'>".$this->currencyDisplay->createPriceDiv('taxAmount','', $this->cart->pricesUnformatted[$pkey],false,false,$prow->quantity)."</span>" ?></td>
                                <?php } ?>
				<td align="right"  data-label="<?php echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?>"><?php echo "<span class='priceColor2'>".$this->currencyDisplay->createPriceDiv('discountAmount','', $this->cart->pricesUnformatted[$pkey],false,false,$prow->quantity)."</span>" ?></td>
				<td colspan="1" align="right"  data-label="<?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?>">
				<?php
		...
		<tr>
		  ...
		  <tr class="sectiontableentry1">
			<td colspan="4" align="right"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
                        ...
                        <?php if ( VmConfig::get('show_tax')) { ?>
			<td align="right" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php echo "<span  class='priceColor2'>".$this->currencyDisplay->createPriceDiv('taxAmount','', $this->cart->pricesUnformatted,false)."</span>" ?></td>
                        <?php } ?>
			...
			<td align="right" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?>"><?php echo $this->currencyDisplay->createPriceDiv('salesPrice','', $this->cart->pricesUnformatted,false) ?></td>
		  </tr>
		...
		<tr class="sectiontableentry1">
		  ...
		  <tr class="sectiontableentry2">
			<td colspan="4" align="right"><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?>: </td>
                        ...
                        <?php if ( VmConfig::get('show_tax')) { ?>
			<td align="right" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"> <?php echo "<span  class='priceColor2'>".$this->currencyDisplay->createPriceDiv('billTaxAmount','', $this->cart->pricesUnformatted['billTaxAmount'],false)."</span>" ?> </td>
                        <?php } ?>
			...
			<td align="right" data-label="<?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?>"><strong><?php echo $this->currencyDisplay->createPriceDiv('billTotal','', $this->cart->pricesUnformatted['billTotal'],false); ?></strong></td>
		  </tr>
		    <?php
